...
EAPI="5"
inherit autotools gnat versionator

IUSE=""

DESCRIPTION="XML library for Ada"
HOMEPAGE="http://libre.adacore.com/xmlada/"
SRC_URI="https://github.com/AdaCore/xmlada/archive/${P}.tar.gz"
...
lib_install() {
	# bug #283160
    emake -j1 prefix="${DL}" libdir="${DL}/lib" datadir="${DL}" install || die "install failed"
