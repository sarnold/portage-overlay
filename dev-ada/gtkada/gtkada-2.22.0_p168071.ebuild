...
inherit eutils gnat versionator subversion
...
#SRC_URI="mirror://gentoo/${Name}-gpl-${PV}.tgz"
ESVN_REPO_URI="http://svn.eu.adacore.com/anonsvn/Dev/trunk/GtkAda@168071"
...
src_prepare() {
	epatch "${FILESDIR}/${Name}-gnat-gcc-4.3.4-obsolescent.patch"
