...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-add-patch-fixing-the-build-with-binutils-2.29.patch \
		"${FILESDIR}"/0001-AArch64-Use-hidden-__GI__dl_argv-in-rtld-startup-cod.patch \
		"${FILESDIR}"/2.19/${PN}-2.19-ia64-gcc-4.8-reloc-hack.patch #503838
