...
IUSE="bluetooth connection-sharing consolekit +dhclient dhcpcd nodhcp gnutls +introspection \
...
src_prepare() {
	...
	# upstream patch for old kernel headers
	epatch "${FILESDIR}"/${PN}-1.0.4-ipv6_old_kernel_headers.patch
