...
inherit autotools eutils xorg-2 vcs-snapshot
...
PATCHES=( "${FILESDIR}"/${PN}-0.2.0-drop-mtrack-test.patch
	"${FILESDIR}"/0001-enable-is_palm-detection-for-pressure-touchpads.patch
	"${FILESDIR}"/0002-added-Bottom-Edge-to-the-X-input-properties.patch
	"${FILESDIR}"/0003-replace-BottomEdge-with-EdgeSize-reject-inputs-comin.patch )
