...
DESCRIPTION="Qtopia Desktop sync application (for use with Qtopia 2) for Qtopia Zaurus ROMs."
...
DEPEND=""
RDEPEND="app-emulation/emul-linux-x86-glibc-errno-compat
	x11-libs/libX11
...
src_install() {
	...
	make_wrapper qtopiadesktop "${QD}/bin/qtopiadesktop" \
	    "/opt/QtopiaDesktop" "/opt/QtopiaDesktop/$(get_libdir)"
	newicon opt/QtopiaDesktop/qtopiadesktop/pics/qtopiadesktop//ProgramIcon2.png \
	    qtopia.png
	make_desktop_entry \
		"qtopiadesktop" \
		"Qtopia Desktop" \
