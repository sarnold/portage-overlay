...
IUSE="${IUSE_VIDEO_CARDS}
	bindist +classic debug +egl exp-ppc-opengl-fixes g3dvl +gallium gbm gles1 gles2 +llvm +nptl openvg osmesa pax_kernel pic selinux shared-dricore +shared-glapi vdpau wayland xa xvmc kernel_FreeBSD"
...
src_prepare() {
	...
	# ppc fixes for OpenGL and correct rendering of texture colors,
	# required for gnome shell and other 3D apps (WIP)
	EPATCH_EXCLUDE+=" 05_mesa-ppc-endian-fixes.patch \
		10_mesa-ppc-endian-fixes.patch \
