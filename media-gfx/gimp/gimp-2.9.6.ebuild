...
inherit versionator virtualx autotools eutils flag-o-matic gnome2 multilib python-single-r1 toolchain-funcs
...
src_configure() {
	# un-molested configure fails to add this
	tc-ld-is-gold && append-libs "-lm"
