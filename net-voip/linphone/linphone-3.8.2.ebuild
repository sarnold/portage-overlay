...
SRC_URI="mirror://nongnu/${PN}/$(get_version_component_range 1-2).x/sources/${P}.tar.gz
	http://dev.gentoo.org/~hasufell/distfiles/${PN}-3.6.1-exosip-4.patch"
...
RDEPEND="
	...
	gsm-nonstandard? ( >=media-libs/mediastreamer-2.11.0[gsm] )
	ncurses? (
		sys-libs/readline:0
		sys-libs/ncurses
	)
	...
	video? ( >=media-libs/mediastreamer-2.11.0[v4l] )
"
DEPEND="${RDEPEND}
	virtual/pkgconfig
...
#		"${DISTDIR}"/${PN}-3.6.1-exosip-4.patch
