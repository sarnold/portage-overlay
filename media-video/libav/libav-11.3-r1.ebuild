...
if [[ ${PV} == *9999 ]] ; then
	...
	AV_URI="https://libav.org/releases/${P}.tar.xz"
	PATCH_URI="https://dev.gentoo.org/~lu_zero/libav/patches/0001-x86-Put-COPY3_IF_LT-under-HAVE_6REGS.patch.gz"
	SRC_URI="${AV_URI} ${PATCH_URI}"
fi
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-libvpxenc.patch # bug 565696
