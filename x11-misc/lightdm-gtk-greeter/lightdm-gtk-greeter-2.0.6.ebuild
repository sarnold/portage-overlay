...
src_prepare() {
	...
	if use touch; then
		elog "To enable the virtual keyboard menu option, you will need to add"
		elog "something like this:"
		elog "   keyboard=onboard"
		elog "to your greeter.conf file."
	fi
