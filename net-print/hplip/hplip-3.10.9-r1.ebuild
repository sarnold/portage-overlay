...
src_prepare() {
	...
	# Interactive mode: option -i not recognized error when built without use=qt4
	# Upstream bug: https://bugs.launchpad.net/hplip/+bug/399522
	# This patch is not yet endorced by upstream
	epatch "${FILESDIR}"/${PN}-3.10.9-interactive.patch
