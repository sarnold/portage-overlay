...
IUSE="+about admin +filemanager lightdm lximage minimal nls
	+policykit powermanagement processviewer screenlock
	screensaver screenshot sddm ssh-askpass sudo terminal
	touch +trash"
...
RDEPEND="
	...
	screensaver? ( x11-misc/xscreensaver )
	...
	touch? (
		sddm? ( dev-qt/qtvirtualkeyboard )
		lightdm? ( app-accessibility/onboard )
	)
