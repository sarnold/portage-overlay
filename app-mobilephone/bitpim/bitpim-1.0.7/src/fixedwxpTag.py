...
#    (in the library version you have to get it from the same module
#     as you get the widget from)
#
# Hopefully this issue can be fixed in the wxPython code and this
# file removed
...
# RCS-ID:      $Id: fixedwxpTag.py 1527 2004-08-25 08:00:32Z rogerb $
