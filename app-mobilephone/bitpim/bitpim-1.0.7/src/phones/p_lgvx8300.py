...
class pbentry(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_emails
            ...
            self.__field_emails=LIST(**{'elementclass': _gen_p_lgvx8300_73, 'length': NUMEMAILS})
        ...
        try: self.__field_numbertypes
            ...
            self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lgvx8300_78, 'length': NUMPHONENUMBERS})
        self.__field_numbertypes.writetobuffer(buf)
        try: self.__field_numbers
        except:
            self.__field_numbers=LIST(**{'elementclass': _gen_p_lgvx8300_80, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_emails(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_emails=LIST(value,**{'elementclass': _gen_p_lgvx8300_73, 'length': NUMEMAILS})
    ...
    def __setfield_numbertypes(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbertypes=LIST(value,**{'elementclass': _gen_p_lgvx8300_78, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_numbers(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbers=LIST(value,**{'elementclass': _gen_p_lgvx8300_80, 'length': NUMPHONENUMBERS})
...
class _gen_p_lgvx8300_73(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8300_73,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8300_73:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8300_73,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8300_73,kwargs)
        if len(args):
...
class _gen_p_lgvx8300_78(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['numbertype']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8300_78,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8300_78:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8300_78,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8300_78,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lgvx8300_80(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['number']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8300_80,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8300_80:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8300_80,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8300_80,kwargs)
        if len(args):
...
class scheduleevent(BaseProtogenClass):
    __fields=['pos', 'description', 'start', 'end_time', 'end_date', 'repeat', 'alarmindex_vibrate', 'ringtone', 'unknown1', 'alarmminutes', 'alarmhours', 'ringpath']
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_ringpath
        except:
            self.__field_ringpath=USTRING(**{'sizeinbytes': 256, 'encoding': PHONE_ENCODING,                 'raiseonunterminatedread': False,                 'raiseontruncate': False,                 'default': '' })
        self.__field_ringpath.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_ringpath=USTRING(**{'sizeinbytes': 256, 'encoding': PHONE_ENCODING,                 'raiseonunterminatedread': False,                 'raiseontruncate': False,                 'default': '' })
        self.__field_ringpath.readfrombuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
    ...
    def __getfield_ringpath(self):
        try: self.__field_ringpath
        except:
            self.__field_ringpath=USTRING(**{'sizeinbytes': 256, 'encoding': PHONE_ENCODING,                 'raiseonunterminatedread': False,                 'raiseontruncate': False,                 'default': '' })
        return self.__field_ringpath.getvalue()

    def __setfield_ringpath(self, value):
        if isinstance(value,USTRING):
            self.__field_ringpath=value
        else:
            self.__field_ringpath=USTRING(value,**{'sizeinbytes': 256, 'encoding': PHONE_ENCODING,                 'raiseonunterminatedread': False,                 'raiseontruncate': False,                 'default': '' })

    def __delfield_ringpath(self): del self.__field_ringpath

    ringpath=property(__getfield_ringpath, __setfield_ringpath, __delfield_ringpath, None)
    ...
    def containerelements(self):
        ...
        yield ('ringpath', self.__field_ringpath, None)
...
class call(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_unknown2=UINT(**{'sizeinbytes': 5})
        self.__field_unknown2.readfrombuffer(buf)
    ...
    def __setfield_unknown2(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown2=UINT(value,**{'sizeinbytes': 5})
...
class msg_record(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvx8300_202, 'length': 219})
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvx8300_202, 'length': 219})
...
class _gen_p_lgvx8300_202(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8300_202,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8300_202:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8300_202,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8300_202,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class recipient_record(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self._bufferstartoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_unknown1=DATA(**{'sizeinbytes': 34})
        self.__field_unknown1.readfrombuffer(buf)
        ...
        self.__field_unknown2.readfrombuffer(buf)
        self.__field_unknown3=DATA(**{'sizeinbytes': 53})
        self.__field_unknown3.readfrombuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
    ...
    def __setfield_unknown1(self, value):
        if isinstance(value,DATA):
            ...
            self.__field_unknown1=DATA(value,**{'sizeinbytes': 34})
    ...
    def __setfield_unknown3(self, value):
        if isinstance(value,DATA):
            ...
            self.__field_unknown3=DATA(value,**{'sizeinbytes': 53})
...
class sms_out(BaseProtogenClass):
    __fields=['index', 'unknown1', 'locked', 'timesent', 'unknown2', 'GPStime', 'subject', 'num_msg_elements', 'messages', 'unknown1', 'priority', 'unknown5', 'callback', 'recipients', 'pad']
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_GPStime=GPSDATE(**{'sizeinbytes': 4})
        self.__field_GPStime.readfrombuffer(buf)
        self.__field_subject=USTRING(**{'sizeinbytes': 24, 'encoding': PHONE_ENCODING})
    ...
    def __setfield_subject(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_subject=USTRING(value,**{'sizeinbytes': 24, 'encoding': PHONE_ENCODING})
...
class SMSINBOXMSGFRAGMENT(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgvx8300_240, 'length': 181}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvx8300_240, 'length': 181})
        self.__field_msg.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvx8300_240, 'length': 181})
...
class _gen_p_lgvx8300_240(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8300_240,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8300_240:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8300_240,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8300_240,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_in(BaseProtogenClass):
    __fields=['unknown1', 'lg_time', 'unknown2', 'GPStime', 'timesent', 'callback_length', 'callback', 'sender_length', 'sender', 'unknown3', 'unknown4', 'read', 'locked', 'priority', 'subject', 'bin_header1', 'bin_header2', 'unknown7', 'multipartID', 'bin_header3', 'unknown8', 'num_msg_elements', 'msglengths', 'unknown9', 'msgs', 'unknown10']
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_sender
            ...
            self.__field_sender=LIST(**{'elementclass': _gen_p_lgvx8300_252, 'length': 38})
        ...
        try: self.__field_msglengths
            ...
            self.__field_msglengths=LIST(**{'elementclass': _gen_p_lgvx8300_267, 'length': 10})
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_callback=USTRING(**{'sizeinbytes': 39})
        self.__field_callback.readfrombuffer(buf)
        ...
        self.__field_unknown3.readfrombuffer(buf)
        self.__field_unknown4=UNKNOWN(**{'sizeinbytes': 6})
        self.__field_unknown4.readfrombuffer(buf)
        ...
        self.__field_unknown8=UINT(**{'sizeinbytes': 5})
        ...
        self.__field_unknown10=UNKNOWN()
    ...
    def __setfield_callback(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_callback=USTRING(value,**{'sizeinbytes': 39})
    ...
    def __setfield_sender(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_sender=LIST(value,**{'elementclass': _gen_p_lgvx8300_252, 'length': 38})
    ...
    def __setfield_unknown4(self, value):
        if isinstance(value,UNKNOWN):
            ...
            self.__field_unknown4=UNKNOWN(value,**{'sizeinbytes': 6})
    ...
    def __setfield_unknown8(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown8=UINT(value,**{'sizeinbytes': 5})
    ...
    def __setfield_msglengths(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msglengths=LIST(value,**{'elementclass': _gen_p_lgvx8300_267, 'length': 10})
    ...
    def __setfield_unknown10(self, value):
        if isinstance(value,UNKNOWN):
            ...
            self.__field_unknown10=UNKNOWN(value,)
...
class _gen_p_lgvx8300_252(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8300_252,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8300_252:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8300_252,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8300_252,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lgvx8300_267(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msglength']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8300_267,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8300_267:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8300_267,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8300_267,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_quick_text(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgvx8300_280,  'length': SMS_CANNED_MAX_ITEMS, 'createdefault': True}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msgs
            ...
            self.__field_msgs=LIST(**{'elementclass': _gen_p_lgvx8300_280,  'length': SMS_CANNED_MAX_ITEMS, 'createdefault': True})
        self.__field_msgs.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def __setfield_msgs(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msgs=LIST(value,**{'elementclass': _gen_p_lgvx8300_280,  'length': SMS_CANNED_MAX_ITEMS, 'createdefault': True})
...
class _gen_p_lgvx8300_280(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msg']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx8300_280,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx8300_280:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx8300_280,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx8300_280,kwargs)
        if len(args):
