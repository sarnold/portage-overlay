...
class pbentry(BaseProtogenClass):
    __fields=['serial1', 'entrysize', 'serial2', 'entrynumber', 'name', 'group', 'emails', 'url', 'ringtone', 'msgringtone', 'secret', 'memo', 'wallpaper', 'unknown1', 'numbertypes', 'numbers', 'unknown20c']
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_emails
            ...
            self.__field_emails=LIST(**{'elementclass': _gen_p_lgux5000_94, 'length': NUMEMAILS})
        ...
        try: self.__field_unknown1
            ...
            self.__field_unknown1=UINT(**{'sizeinbytes': 9,  'default': 0 })
        self.__field_unknown1.writetobuffer(buf)
        try: self.__field_numbertypes
        except:
            self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lgux5000_103, 'length': NUMPHONENUMBERS})
        self.__field_numbertypes.writetobuffer(buf)
        try: self.__field_numbers
        except:
            self.__field_numbers=LIST(**{'elementclass': _gen_p_lgux5000_105, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_emails(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_emails=LIST(value,**{'elementclass': _gen_p_lgux5000_94, 'length': NUMEMAILS})
    ...
    def __setfield_unknown1(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown1=UINT(value,**{'sizeinbytes': 9,  'default': 0 })
    ...
    def __setfield_numbertypes(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbertypes=LIST(value,**{'elementclass': _gen_p_lgux5000_103, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_numbers(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbers=LIST(value,**{'elementclass': _gen_p_lgux5000_105, 'length': NUMPHONENUMBERS})
...
class _gen_p_lgux5000_94(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgux5000_94,self).__init__(**dict)
        if self.__class__ is _gen_p_lgux5000_94:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgux5000_94,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgux5000_94,kwargs)
        if len(args):
...
class _gen_p_lgux5000_103(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['numbertype']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgux5000_103,self).__init__(**dict)
        if self.__class__ is _gen_p_lgux5000_103:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgux5000_103,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgux5000_103,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lgux5000_105(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['number']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgux5000_105,self).__init__(**dict)
        if self.__class__ is _gen_p_lgux5000_105:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgux5000_105,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgux5000_105,kwargs)
        if len(args):
...
class call(BaseProtogenClass):
    __fields=['GPStime', 'unknown1', 'duration', 'number', 'name', 'numberlength', 'unknown2', 'pbnumbertype', 'unknown3', 'pbentrynum', 'unknown9']
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_unknown9=UINT(**{'sizeinbytes': 9})
    ...
    def __setfield_unknown9(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown9=UINT(value,**{'sizeinbytes': 9})
...
class SMSINBOXMSGFRAGMENT(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgux5000_262, 'length': 181}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgux5000_262, 'length': 181})
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgux5000_262, 'length': 181})
...
class _gen_p_lgux5000_262(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgux5000_262,self).__init__(**dict)
        if self.__class__ is _gen_p_lgux5000_262:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgux5000_262,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgux5000_262,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_in(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_sender
            ...
            self.__field_sender=LIST(**{'elementclass': _gen_p_lgux5000_275, 'length': 38})
        ...
        try: self.__field_msglengths
            ...
            self.__field_msglengths=LIST(**{'elementclass': _gen_p_lgux5000_293, 'length': 20})
    ...
    def __setfield_sender(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_sender=LIST(value,**{'elementclass': _gen_p_lgux5000_275, 'length': 38})
    ...
    def __setfield_msglengths(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msglengths=LIST(value,**{'elementclass': _gen_p_lgux5000_293, 'length': 20})
...
class _gen_p_lgux5000_275(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgux5000_275,self).__init__(**dict)
        if self.__class__ is _gen_p_lgux5000_275:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgux5000_275,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgux5000_275,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lgux5000_293(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msglength']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgux5000_293,self).__init__(**dict)
        if self.__class__ is _gen_p_lgux5000_293:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgux5000_293,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgux5000_293,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_quick_text(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgux5000_309, }
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msgs
            ...
            self.__field_msgs=LIST(**{'elementclass': _gen_p_lgux5000_309, })
        self.__field_msgs.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def __setfield_msgs(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msgs=LIST(value,**{'elementclass': _gen_p_lgux5000_309, })
...
class _gen_p_lgux5000_309(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msg']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgux5000_309,self).__init__(**dict)
        if self.__class__ is _gen_p_lgux5000_309:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgux5000_309,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgux5000_309,kwargs)
        if len(args):
