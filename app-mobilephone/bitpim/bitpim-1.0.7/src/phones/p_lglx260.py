...
class pbentry(BaseProtogenClass):
    __fields=['wallpaper', 'serial1', 'entrysize', 'serial2', 'entrynumber', 'unknown0', 'name', 'unknown1', 'group', 'unknown1a', 'memo', 'emails', 'url', 'unknownf1', 'unknownf2', 'unknownf3', 'unknownf4', 'unknownf5', 'numbertypes', 'numbers', 'unknown2']
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_entrysize
            ...
            self.__field_entrysize=UINT(**{'sizeinbytes': 2, 'constant': 0x02A0})
        ...
        try: self.__field_unknown0
            ...
            self.__field_unknown0=UINT(**{'sizeinbytes': 2, 'default': 0})
        self.__field_unknown0.writetobuffer(buf)
        self.__field_name.writetobuffer(buf)
        try: self.__field_unknown1
        except:
            self.__field_unknown1=UNKNOWN(**{'sizeinbytes': 40})
        self.__field_unknown1.writetobuffer(buf)
        self.__field_group.writetobuffer(buf)
        try: self.__field_unknown1a
        except:
            self.__field_unknown1a=UNKNOWN(**{'sizeinbytes': 7})
        self.__field_unknown1a.writetobuffer(buf)
        self.__field_memo.writetobuffer(buf)
        try: self.__field_emails
        except:
            self.__field_emails=LIST(**{'elementclass': _gen_p_lglx260_126, 'length': NUMEMAILS})
        self.__field_emails.writetobuffer(buf)
        self.__field_url.writetobuffer(buf)
        try: self.__field_unknownf1
        except:
            self.__field_unknownf1=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf1.writetobuffer(buf)
        try: self.__field_unknownf2
        except:
            self.__field_unknownf2=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf2.writetobuffer(buf)
        try: self.__field_unknownf3
        except:
            self.__field_unknownf3=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf3.writetobuffer(buf)
        try: self.__field_unknownf4
        except:
            self.__field_unknownf4=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf4.writetobuffer(buf)
        try: self.__field_unknownf5
        except:
            self.__field_unknownf5=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf5.writetobuffer(buf)
        try: self.__field_numbertypes
        except:
            self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lglx260_134, 'length': NUMPHONENUMBERS})
        self.__field_numbertypes.writetobuffer(buf)
        try: self.__field_numbers
        except:
            self.__field_numbers=LIST(**{'elementclass': _gen_p_lglx260_136, 'length': NUMPHONENUMBERS})
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_name=USTRING(**{'sizeinbytes': 33, 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': True})
        self.__field_name.readfrombuffer(buf)
        self.__field_unknown1=UNKNOWN(**{'sizeinbytes': 40})
        ...
        self.__field_unknown1a=UNKNOWN(**{'sizeinbytes': 7})
        self.__field_unknown1a.readfrombuffer(buf)
        self.__field_memo=USTRING(**{'sizeinbytes': 33, 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': True})
        self.__field_memo.readfrombuffer(buf)
        self.__field_emails=LIST(**{'elementclass': _gen_p_lglx260_126, 'length': NUMEMAILS})
        self.__field_emails.readfrombuffer(buf)
        self.__field_url=USTRING(**{'sizeinbytes': 73, 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': True})
        self.__field_url.readfrombuffer(buf)
        self.__field_unknownf1=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf1.readfrombuffer(buf)
        self.__field_unknownf2=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf2.readfrombuffer(buf)
        self.__field_unknownf3=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf3.readfrombuffer(buf)
        self.__field_unknownf4=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf4.readfrombuffer(buf)
        self.__field_unknownf5=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        self.__field_unknownf5.readfrombuffer(buf)
        self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lglx260_134, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_entrysize(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_entrysize=UINT(value,**{'sizeinbytes': 2, 'constant': 0x02A0})
    ...
    def __setfield_unknown0(self, value):
        if isinstance(value,UINT):
            ...
            self.__field_unknown0=UINT(value,**{'sizeinbytes': 2, 'default': 0})
    ...
    def __setfield_name(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_name=USTRING(value,**{'sizeinbytes': 33, 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': True})
    ...
    def __setfield_unknown1(self, value):
        if isinstance(value,UNKNOWN):
            ...
            self.__field_unknown1=UNKNOWN(value,**{'sizeinbytes': 40})
    ...
    def __getfield_unknown1a(self):
        try: self.__field_unknown1a
        except:
            self.__field_unknown1a=UNKNOWN(**{'sizeinbytes': 7})
        return self.__field_unknown1a.getvalue()

    def __setfield_unknown1a(self, value):
        if isinstance(value,UNKNOWN):
            self.__field_unknown1a=value
        else:
            self.__field_unknown1a=UNKNOWN(value,**{'sizeinbytes': 7})

    def __delfield_unknown1a(self): del self.__field_unknown1a

    unknown1a=property(__getfield_unknown1a, __setfield_unknown1a, __delfield_unknown1a, None)
    ...
    def __setfield_memo(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_memo=USTRING(value,**{'sizeinbytes': 33, 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': True})
    ...
    def __setfield_emails(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_emails=LIST(value,**{'elementclass': _gen_p_lglx260_126, 'length': NUMEMAILS})
    ...
    def __setfield_url(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_url=USTRING(value,**{'sizeinbytes': 73, 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': True})

    def __delfield_url(self): del self.__field_url

    url=property(__getfield_url, __setfield_url, __delfield_url, None)

    def __getfield_unknownf1(self):
        try: self.__field_unknownf1
        except:
            self.__field_unknownf1=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        return self.__field_unknownf1.getvalue()

    def __setfield_unknownf1(self, value):
        if isinstance(value,UINT):
            self.__field_unknownf1=value
        else:
            self.__field_unknownf1=UINT(value,**{'sizeinbytes': 1, 'default': 0xff})

    def __delfield_unknownf1(self): del self.__field_unknownf1

    unknownf1=property(__getfield_unknownf1, __setfield_unknownf1, __delfield_unknownf1, None)

    def __getfield_unknownf2(self):
        try: self.__field_unknownf2
        except:
            self.__field_unknownf2=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        return self.__field_unknownf2.getvalue()

    def __setfield_unknownf2(self, value):
        if isinstance(value,UINT):
            self.__field_unknownf2=value
        else:
            self.__field_unknownf2=UINT(value,**{'sizeinbytes': 1, 'default': 0xff})

    def __delfield_unknownf2(self): del self.__field_unknownf2

    unknownf2=property(__getfield_unknownf2, __setfield_unknownf2, __delfield_unknownf2, None)

    def __getfield_unknownf3(self):
        try: self.__field_unknownf3
        except:
            self.__field_unknownf3=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        return self.__field_unknownf3.getvalue()

    def __setfield_unknownf3(self, value):
        if isinstance(value,UINT):
            self.__field_unknownf3=value
        else:
            self.__field_unknownf3=UINT(value,**{'sizeinbytes': 1, 'default': 0xff})

    def __delfield_unknownf3(self): del self.__field_unknownf3

    unknownf3=property(__getfield_unknownf3, __setfield_unknownf3, __delfield_unknownf3, None)

    def __getfield_unknownf4(self):
        try: self.__field_unknownf4
        except:
            self.__field_unknownf4=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        return self.__field_unknownf4.getvalue()

    def __setfield_unknownf4(self, value):
        if isinstance(value,UINT):
            self.__field_unknownf4=value
        else:
            self.__field_unknownf4=UINT(value,**{'sizeinbytes': 1, 'default': 0xff})

    def __delfield_unknownf4(self): del self.__field_unknownf4

    unknownf4=property(__getfield_unknownf4, __setfield_unknownf4, __delfield_unknownf4, None)

    def __getfield_unknownf5(self):
        try: self.__field_unknownf5
        except:
            self.__field_unknownf5=UINT(**{'sizeinbytes': 1, 'default': 0xff})
        return self.__field_unknownf5.getvalue()

    def __setfield_unknownf5(self, value):
        if isinstance(value,UINT):
            self.__field_unknownf5=value
        else:
            self.__field_unknownf5=UINT(value,**{'sizeinbytes': 1, 'default': 0xff})

    def __delfield_unknownf5(self): del self.__field_unknownf5

    unknownf5=property(__getfield_unknownf5, __setfield_unknownf5, __delfield_unknownf5, None)
    ...
    def __setfield_numbertypes(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbertypes=LIST(value,**{'elementclass': _gen_p_lglx260_134, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_numbers(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbers=LIST(value,**{'elementclass': _gen_p_lglx260_136, 'length': NUMPHONENUMBERS})
    ...
    def containerelements(self):
        ...
        yield ('unknown1a', self.__field_unknown1a, None)
        yield ('memo', self.__field_memo, None)
        yield ('emails', self.__field_emails, None)
        yield ('url', self.__field_url, None)
        yield ('unknownf1', self.__field_unknownf1, None)
        yield ('unknownf2', self.__field_unknownf2, None)
        yield ('unknownf3', self.__field_unknownf3, None)
        yield ('unknownf4', self.__field_unknownf4, None)
        yield ('unknownf5', self.__field_unknownf5, None)
...
class _gen_p_lglx260_126(BaseProtogenClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lglx260_126,self).__init__(**dict)
        if self.__class__ is _gen_p_lglx260_126:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lglx260_126,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglx260_126,kwargs)
        if len(args):
            dict2={'sizeinbytes': 73, 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': True}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self._bufferstartoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_email=USTRING(**{'sizeinbytes': 73, 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': True})
    ...
    def __setfield_email(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_email=USTRING(value,**{'sizeinbytes': 73, 'encoding': PHONE_ENCODING, 'raiseonunterminatedread': True})
...
class _gen_p_lglx260_134(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['numbertype']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lglx260_134,self).__init__(**dict)
        if self.__class__ is _gen_p_lglx260_134:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lglx260_134,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglx260_134,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lglx260_136(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['number']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lglx260_136,self).__init__(**dict)
        if self.__class__ is _gen_p_lglx260_136:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lglx260_136,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglx260_136,kwargs)
        if len(args):
            dict2={'sizeinbytes': 49, 'raiseonunterminatedread': True}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self._bufferstartoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_number=USTRING(**{'sizeinbytes': 49, 'raiseonunterminatedread': True})
        self.__field_number.readfrombuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
    ...
    def __setfield_number(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_number=USTRING(value,**{'sizeinbytes': 49, 'raiseonunterminatedread': True})
...
class msg_record(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lglx260_260, 'length': 219})
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lglx260_260, 'length': 219})
...
class _gen_p_lglx260_260(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lglx260_260,self).__init__(**dict)
        if self.__class__ is _gen_p_lglx260_260:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lglx260_260,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglx260_260,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class SMSINBOXMSGFRAGMENT(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lglx260_297, 'length': 181}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lglx260_297, 'length': 181})
        self.__field_msg.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lglx260_297, 'length': 181})
...
class _gen_p_lglx260_297(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lglx260_297,self).__init__(**dict)
        if self.__class__ is _gen_p_lglx260_297:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lglx260_297,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglx260_297,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_in(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_sender
            ...
            self.__field_sender=LIST(**{'elementclass': _gen_p_lglx260_310, 'length': 38})
        ...
        try: self.__field_msglengths
            ...
            self.__field_msglengths=LIST(**{'elementclass': _gen_p_lglx260_329, 'length': 10})
    ...
    def __setfield_sender(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_sender=LIST(value,**{'elementclass': _gen_p_lglx260_310, 'length': 38})
    ...
    def __setfield_msglengths(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msglengths=LIST(value,**{'elementclass': _gen_p_lglx260_329, 'length': 10})
...
class _gen_p_lglx260_310(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lglx260_310,self).__init__(**dict)
        if self.__class__ is _gen_p_lglx260_310:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lglx260_310,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglx260_310,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lglx260_329(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msglength']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lglx260_329,self).__init__(**dict)
        if self.__class__ is _gen_p_lglx260_329:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lglx260_329,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglx260_329,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_quick_text(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lglx260_344, }
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msgs
            ...
            self.__field_msgs=LIST(**{'elementclass': _gen_p_lglx260_344, })
        self.__field_msgs.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def __setfield_msgs(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msgs=LIST(value,**{'elementclass': _gen_p_lglx260_344, })
...
class _gen_p_lglx260_344(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msg']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lglx260_344,self).__init__(**dict)
        if self.__class__ is _gen_p_lglx260_344:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lglx260_344,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lglx260_344,kwargs)
        if len(args):
