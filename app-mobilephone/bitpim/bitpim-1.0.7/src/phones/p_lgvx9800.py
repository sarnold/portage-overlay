...
class indexentry(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self.__field_filename=USTRING(**{'sizeinbytes': 80, 'encoding': PHONE_ENCODING,                'raiseonunterminatedread': False,                'raiseontruncate': False })
    ...
    def __setfield_filename(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_filename=USTRING(value,**{'sizeinbytes': 80, 'encoding': PHONE_ENCODING,                'raiseonunterminatedread': False,                'raiseontruncate': False })
...
class playlistentry(BaseProtogenClass):
    ...
    def readfrombuffer(self,buf,autolog=True,logtitle="<read data>"):
        ...
        self._bufferstartoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologread(buf, logtitle=logtitle)
        self.__field_name=USTRING(**{'sizeinbytes': 84,  'encoding': PHONE_ENCODING,                 'raiseonunterminatedread': False,                 'raiseontruncate': False })
    ...
    def __setfield_name(self, value):
        if isinstance(value,USTRING):
            ...
            self.__field_name=USTRING(value,**{'sizeinbytes': 84,  'encoding': PHONE_ENCODING,                 'raiseonunterminatedread': False,                 'raiseontruncate': False })
...
class pbentry(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_emails
            ...
            self.__field_emails=LIST(**{'elementclass': _gen_p_lgvx9800_132, 'length': NUMEMAILS})
        ...
        try: self.__field_numbertypes
            ...
            self.__field_numbertypes=LIST(**{'elementclass': _gen_p_lgvx9800_137, 'length': NUMPHONENUMBERS})
        self.__field_numbertypes.writetobuffer(buf)
        try: self.__field_numbers
        except:
            self.__field_numbers=LIST(**{'elementclass': _gen_p_lgvx9800_139, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_emails(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_emails=LIST(value,**{'elementclass': _gen_p_lgvx9800_132, 'length': NUMEMAILS})
    ...
    def __setfield_numbertypes(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbertypes=LIST(value,**{'elementclass': _gen_p_lgvx9800_137, 'length': NUMPHONENUMBERS})
    ...
    def __setfield_numbers(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_numbers=LIST(value,**{'elementclass': _gen_p_lgvx9800_139, 'length': NUMPHONENUMBERS})
...
class _gen_p_lgvx9800_137(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['numbertype']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx9800_137,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx9800_137:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx9800_137,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx9800_137,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lgvx9800_139(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['number']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx9800_139,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx9800_139:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx9800_139,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx9800_139,kwargs)
        if len(args):
...
class msg_record(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvx9800_288, 'length': 220})
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvx9800_288, 'length': 220})
...
class _gen_p_lgvx9800_288(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx9800_288,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx9800_288:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx9800_288,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx9800_288,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class SMSINBOXMSGFRAGMENT(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgvx9800_311, 'length': 181}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msg
            ...
            self.__field_msg=LIST(**{'elementclass': _gen_p_lgvx9800_311, 'length': 181})
        self.__field_msg.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def __setfield_msg(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msg=LIST(value,**{'elementclass': _gen_p_lgvx9800_311, 'length': 181})
...
class _gen_p_lgvx9800_311(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx9800_311,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx9800_311:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx9800_311,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx9800_311,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_in(BaseProtogenClass):
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_sender
            ...
            self.__field_sender=LIST(**{'elementclass': _gen_p_lgvx9800_323, 'length': 38})
        ...
        try: self.__field_msglengths
            ...
            self.__field_msglengths=LIST(**{'elementclass': _gen_p_lgvx9800_343, 'length': 20})
    ...
    def __setfield_sender(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_sender=LIST(value,**{'elementclass': _gen_p_lgvx9800_323, 'length': 38})
    ...
    def __setfield_msglengths(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msglengths=LIST(value,**{'elementclass': _gen_p_lgvx9800_343, 'length': 20})
...
class _gen_p_lgvx9800_323(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['byte']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx9800_323,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx9800_323:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx9800_323,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx9800_323,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class _gen_p_lgvx9800_343(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msglength']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx9800_343,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx9800_343:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx9800_343,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx9800_343,kwargs)
        if len(args):
            dict2={'sizeinbytes': 1}
            dict2.update(kwargs)
            kwargs=dict2
...
class sms_quick_text(BaseProtogenClass):
    ...
    def _update(self, args, kwargs):
        ...
        if len(args):
            dict2={'elementclass': _gen_p_lgvx9800_357, 'length': SMS_CANNED_MAX_ITEMS, 'createdefault': True}
            dict2.update(kwargs)
            kwargs=dict2
    ...
    def writetobuffer(self,buf,autolog=True,logtitle="<written data>"):
        ...
        try: self.__field_msgs
            ...
            self.__field_msgs=LIST(**{'elementclass': _gen_p_lgvx9800_357, 'length': SMS_CANNED_MAX_ITEMS, 'createdefault': True})
        self.__field_msgs.writetobuffer(buf)
        self._bufferendoffset=buf.getcurrentoffset()
        if autolog and self._bufferstartoffset==0: self.autologwrite(buf, logtitle=logtitle)
    ...
    def __setfield_msgs(self, value):
        if isinstance(value,LIST):
            ...
            self.__field_msgs=LIST(value,**{'elementclass': _gen_p_lgvx9800_357, 'length': SMS_CANNED_MAX_ITEMS, 'createdefault': True})
...
class _gen_p_lgvx9800_357(BaseProtogenClass):
    'Anonymous inner class'
    __fields=['msg']
    ...
    def __init__(self, *args, **kwargs):
        ...
        dict.update(kwargs)
        # Parent constructor
        super(_gen_p_lgvx9800_357,self).__init__(**dict)
        if self.__class__ is _gen_p_lgvx9800_357:
            self._update(args,dict)
    ...
    def _update(self, args, kwargs):
        super(_gen_p_lgvx9800_357,self)._update(args,kwargs)
        keys=kwargs.keys()
        for key in keys:
            if key in self.__fields:
                setattr(self, key, kwargs[key])
        ...
        # Were any unrecognized kwargs passed in?
        if __debug__:
            self._complainaboutunusedargs(_gen_p_lgvx9800_357,kwargs)
        if len(args):
