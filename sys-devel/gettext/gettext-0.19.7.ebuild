...
inherit eutils flag-o-matic mono-env libtool java-pkg-opt-2 multilib-minimal toolchain-funcs
...
multilib_src_configure() {
	append-libs "-lm"  # needs this on arm64 or with -flto

	if tc-is-cross-compiler ; then
	        PKG_CONFIG_LIBDIR="${SYSROOT}/usr/$(get_libdir)/pkgconfig"
		tc-export PKG_CONFIG
        	append-libs "-L${SYSROOT}/$(get_libdir) -L${SYSROOT}/usr/$(get_libdir)"
	fi
