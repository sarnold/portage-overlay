...
# $Header: /var/cvsroot/gentoo-x86/sys-power/nut/nut-2.4.1-r1.ebuild,v 1.6 2009/09/05 15:26:41 armin76 Exp $
...
src_install() {
	...
	# update for new udev rule syntax
	dosed "s|SYSFS|ATTRS|g" /etc/udev/rules.d/70-nut-usbups.rules
