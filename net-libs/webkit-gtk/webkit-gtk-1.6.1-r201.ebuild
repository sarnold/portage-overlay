...
# $Header: /var/cvsroot/gentoo-x86/net-libs/webkit-gtk/webkit-gtk-1.6.1-r201.ebuild,v 1.11 2012/05/05 02:54:26 jdhore Exp $
...
src_prepare() {
	...
	# update with equivalent fix for bug #401855
	epatch "${FILESDIR}"/${P}-gmutex.patch
