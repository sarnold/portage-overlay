...
IUSE="aqua coverage doc +egl +geoloc gles2 glx gnome-keyring +gstreamer +introspection +jit neon nsplugin +opengl spell wayland +webgl X"
# seccomp
...
RDEPEND="
	...
	webgl? (
		x11-libs/cairo[X]
		|| ( x11-libs/cairo[gles2] x11-libs/cairo[opengl] )
