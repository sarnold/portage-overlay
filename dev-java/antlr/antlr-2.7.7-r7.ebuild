...
inherit base java-pkg-2 mono autotools distutils-r1 multilib flag-o-matic toolchain-funcs versionator
...
IUSE="doc debug examples mono +cxx python script source static-libs"
...
src_configure() {
	# the CXXFLAGS method only works on the cpp lib objs, still
	# bombs with -fPIC/reloc link error
	append-cppflags -DPIC -fPIC
