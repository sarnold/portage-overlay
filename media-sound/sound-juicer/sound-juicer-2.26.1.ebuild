...
# $Header: /var/cvsroot/gentoo-x86/media-sound/sound-juicer/sound-juicer-2.26.1.ebuild,v 1.3 2009/05/17 14:48:02 klausman Exp $
...
COMMON_DEPEND=">=dev-libs/glib-2.16
	...
	|| (
		>=gnome-extra/nautilus-cd-burner-2.21.6
